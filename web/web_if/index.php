...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $_SERVER['REQUEST_SCHEME']."://".$_SERVER['HTTP_HOST']?>/style/normalize.css">
  <link rel="stylesheet" href="<?php echo $_SERVER['REQUEST_SCHEME']."://".$_SERVER['HTTP_HOST']?>/style/custom.css">
